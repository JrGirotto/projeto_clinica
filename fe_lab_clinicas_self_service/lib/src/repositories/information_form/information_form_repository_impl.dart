  ...
  Future<Either<RepositoryException, Unit>> register(
    ...
    try {
      final SelfServiceModel(
        ...
        documents: {
          DocumentType.healthInsuranceCard: List(first: healthInsuranceDocs),
          DocumentType.medicalOrder: List(first: medicalOrderDocs),
        }!
      ) = model;
      await restClient.auth.post('/patientInformationForm', data: {
        'patient_id': patientId,
        'health_insurance_card': healthInsuranceDocs,
